    ...
    public function run()
    {
        $data = [
            [
                ...
                'file_path'    => 'uploads/bibles/kjv.json',
            ...
            [
                ...
                'file_path'    => 'uploads/bibles/niv.json',
            ...
            [
                ...
                'file_path'    => 'uploads/bibles/esv.json',
                'file_size'    => 5000000,
                'version'      => '1.5',
                'is_active'    => 1,
                'created_at'   => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'file_path'    => 'uploads/bibles/rvr60.json',
                'file_size'    => 4800000,
                'version'      => '1.0',
                'is_active'    => 1,
                'created_at'   => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'file_path'    => 'uploads/bibles/lsg.json',
                'file_size'    => 4900000,
                'version'      => '1.0',
                'is_active'    => 1,
                'created_at'   => date('Y-m-d H:i:s'),
